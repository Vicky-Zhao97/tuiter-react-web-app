...
console.log('%cParenthesis and parameters','font-weight: bold');
const square = a => a * a;
const plusOne = a => a + 1;
...
// Arrays
console.log('%cArrays','font-weight: bold');
...
console.log('%cArray index and length','font-weight: bold');
...
// adding new items
console.log('%cAdd and remove data to arrays','font-weight: bold');
numberArray1.push(6);
...
//  For Loops
console.log('%cFor loops','font-weight: bold');
...
// The Map Function
console.log('%cMap function','font-weight: bold');
...
// The Find Function
console.log('%cFind function','font-weight: bold')
...
console.log('%cFind index','font-weight: bold');
...
// The Filter Function
console.log('%cFilter function','font-weight: bold');
...
// Template Strings
console.log('%cTemplate strings','font-weight: bold');
const five = 2 + 3;
...
const init = () => {
    ...
    //get
    console.log('%cGet and set attributes','font-weight: bold')
